    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900 p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow border border-gray-200 dark:border-slate-700 p-8">
          ...
          {/* Demo Accounts */}
          <div className="mt-8 p-5 bg-gray-50 dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-600">
            <p className="text-xs font-semibold text-gray-600 dark:text-gray-400 mb-3">
              Tài khoản demo
            </p>
            <div className="space-y-2 text-xs">
              <div className="flex items-center justify-between p-2 bg-white dark:bg-slate-800 rounded-lg cursor-pointer" onClick={() => { setIdentifier("owner"); setPassword("123456") }}>
              ...
              <div className="flex items-center justify-between p-2 bg-white dark:bg-slate-800 rounded-lg cursor-pointer" onClick={() => { setIdentifier("teacher"); setPassword("123456") }}>
              ...
              <div className="flex items-center justify-between p-2 bg-white dark:bg-slate-800 rounded-lg cursor-pointer" onClick={() => { setIdentifier("student"); setPassword("123456") }}>
              ...
              <div className="flex items-center justify-between p-2 bg-white dark:bg-slate-800 rounded-lg cursor-pointer" onClick={() => { setIdentifier("parent"); setPassword("123456") }}>
              ...
              <div className="flex items-center justify-between p-2 bg-white dark:bg-slate-800 rounded-lg cursor-pointer" onClick={() => { setIdentifier("admin"); setPassword("123456") }}>
