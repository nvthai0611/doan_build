    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-blue-900">Tổng quan học sinh</h1>
          </div>
        </div>
        <div className="flex items-center gap-3 flex-wrap">
          ...
          {profile?.studentCode && (
            <span className="text-sm text-blue-800 bg-white rounded-md px-3 py-1 border border-blue-300 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <a href="/student/my-classes" className="group bg-white border rounded-xl p-6 hover:shadow-lg transition-all duration-300 border-l-4 border-l-blue-600 hover:border-l-blue-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-800 group-hover:text-blue-700 transition-colors">Lớp học của tôi</h3>
        ...
        <a href="/student/my-schedule" className="group bg-white border rounded-xl p-6 hover:shadow-lg transition-all duration-300 border-l-4 border-l-blue-600 hover:border-l-blue-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="p-3 bg-blue-100 rounded-xl group-hover:bg-blue-200 transition-colors">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-800 group-hover:text-blue-700 transition-colors">Lịch học</h3>
        ...
        <a href="/student/my-grades" className="group bg-white border rounded-xl p-6 hover:shadow-lg transition-all duration-300 border-l-4 border-l-blue-600 hover:border-l-blue-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="p-3 bg-blue-100 rounded-xl group-hover:bg-blue-200 transition-colors">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-800 group-hover:text-blue-700 transition-colors">Bảng điểm</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300">
          ...
          <div className="text-sm font-medium text-blue-900">Lớp đang học</div>
          <div className="text-xs text-blue-700 mt-1">Số lớp bạn đang tham gia</div>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <div className="text-3xl font-bold text-blue-800">{upcomingSessions?.length ?? 0}</div>
            </div>
          </div>
          <div className="text-sm font-medium text-blue-900">Buổi sắp tới trong tuần</div>
          <div className="text-xs text-blue-700 mt-1">Số buổi học sắp diễn ra</div>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <div className="text-3xl font-bold text-blue-800 flex items-center gap-1">
          ...
          <div className="text-sm font-medium text-blue-900">GPA tích lũy</div>
          <div className="text-xs text-blue-700 mt-1">Điểm trung bình tổng kết</div>
        </div>
      </div>
        ...
        <div className="bg-white border rounded-xl p-6 shadow-sm">
          ...
          <div className="space-y-3">
            {upcomingSessions.slice(0, 3).map((session: unknown, index: number) => {
              ...
              return (
                <div key={(sessionData.id as string) || index} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <div className="p-2 bg-blue-100 rounded-lg">
          ...
          {upcomingSessions.length > 3 && (
            <div className="mt-4 text-center">
              <a href="/student/my-schedule" className="text-sm text-blue-700 hover:text-blue-800 font-medium">
