...
exports.classRemoveTeacherEmailTemplate = void 0;
const classRemoveTeacherEmailTemplate = (teacherName, className, reason) => {
    return `
    <!DOCTYPE html>
    <html lang="vi">
    <head>
...
exports.classRemoveTeacherEmailTemplate = classRemoveTeacherEmailTemplate;
//# sourceMappingURL=template-class-remove-teacher.template.js.map