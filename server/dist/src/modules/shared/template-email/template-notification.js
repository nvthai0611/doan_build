...
exports.paymentSuccessEmailTemplate = exports.multipleAbsenceEmailTemplate = exports.studentAbsenceEmailTemplate = void 0;
const studentAbsenceEmailTemplate = (studentName, className, absenceDate, sessionTime, subject, teacherName, note) => {
    return `
    <!DOCTYPE html>
    <html lang="vi">
    <head>
...
exports.studentAbsenceEmailTemplate = studentAbsenceEmailTemplate;
const multipleAbsenceEmailTemplate = (studentName, className, absenceCount, absenceDates, totalSessions, attendanceRate) => {
    return `
    <!DOCTYPE html>
    <html lang="vi">
    <head>
...
exports.multipleAbsenceEmailTemplate = multipleAbsenceEmailTemplate;
const paymentSuccessEmailTemplate = (data) => {
...
//# sourceMappingURL=template-notification.js.map