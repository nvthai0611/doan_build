...
exports.CountByStatusResponseDto = exports.ClassResponseDto = exports.ClassesListResponseDto = exports.ClassDto = exports.RoomDto = void 0;
...
class ClassDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, name: { required: true, type: () => String }, teacherId: { required: true, type: () => String }, room: { required: true, type: () => require("./response-class.dto").RoomDto }, createdAt: { required: true, type: () => Date }, updatedAt: { required: true, type: () => Date } };
    }
}
...
class ClassesListResponseDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { success: { required: true, type: () => Boolean }, message: { required: true, type: () => String }, data: { required: true, type: () => [require("./response-class.dto").ClassDto] } };
    }
}
...
class CountByStatusResponseDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { total: { required: true, type: () => Number }, active: { required: true, type: () => Number }, completed: { required: true, type: () => Number }, draft: { required: true, type: () => Number }, cancelled: { required: true, type: () => Number } };
    }
}
exports.CountByStatusResponseDto = CountByStatusResponseDto;
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Tổng số lớp học' }),
    __metadata("design:type", Number)
], CountByStatusResponseDto.prototype, "total", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Số lớp học hoạt động' }),
    __metadata("design:type", Number)
], CountByStatusResponseDto.prototype, "active", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Số lớp học hoàn thành' }),
    __metadata("design:type", Number)
], CountByStatusResponseDto.prototype, "completed", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Số lớp học theo kế hoạch' }),
    __metadata("design:type", Number)
], CountByStatusResponseDto.prototype, "draft", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Số lớp học hủy' }),
    __metadata("design:type", Number)
], CountByStatusResponseDto.prototype, "cancelled", void 0);
//# sourceMappingURL=response-class.dto.js.map