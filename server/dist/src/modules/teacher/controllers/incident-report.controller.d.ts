...
export declare class IncidentReportController {
    private readonly incidentReportService;
    constructor(incidentReportService: IncidentReportService);
    ...
    findMyReports(req: any, page?: string, limit?: string, status?: string): Promise<{
        data: ({
            class: {
    ...
    getDetail(req: any, id: string): Promise<{
        data: {
            class: {
                academicYear: string | null;
                password: string | null;
