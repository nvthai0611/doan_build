...
export declare class TeacherStudentLeaveRequestController {
    private readonly studentLeaveRequestService;
    constructor(studentLeaveRequestService: TeacherStudentLeaveRequestService);
    ...
    approveOrRejectStudentLeaveRequest(req: any, id: string, action: 'approve' | 'reject', dto: ApproveRejectStudentLeaveRequestDto): Promise<{
        success: boolean;
        data: {
            classes: any[];
            student: {
