...
export declare class IncidentReportService {
    ...
    createIncidentReport(teacherId: string, body: any): Promise<{
        data: {
            createdAt: Date;
            updatedAt: Date;
            id: string;
    ...
    getMyIncidentReports(teacherId: string, options: {
        page: number;
        limit: number;
        status?: string;
    }): Promise<{
    ...
    getIncidentReportDetail(teacherId: string, id: string): Promise<{
        data: {
            class: {
                academicYear: string | null;
                password: string | null;
