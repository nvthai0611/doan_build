...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Địa chỉ trường học', example: '123 Main St', required: false }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(32, { message: 'Mật khẩu không được quá 32 ký tự' }),
    __metadata("design:type", String)
