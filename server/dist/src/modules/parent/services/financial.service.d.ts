...
export declare class FinancialService {
    ...
    getAllFeeRecordsForParent(parentId: string, status: string): Promise<{
        student: {
    ...
    getPaymentForParentByStatus(parentId: string, status: string): Promise<{
        id: any;
        date: any;
        amount: number;
        paidAmount: number;
    ...
    createPaymentForFeeRecords(parentId: string, feeRecordIds: string[]): Promise<{
        data: {
            feeRecordPayments: {
                createdAt: Date | null;
                updatedAt: Date | null;
    ...
    updatePaymentFeeRecords(paymentId: string, feeRecordIds: string[], parentId: string): Promise<{
        data: boolean;
        message: string;
    }>;
}
