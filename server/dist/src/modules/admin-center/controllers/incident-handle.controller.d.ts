...
export declare class IncidentHandleController {
    private readonly incidentHandleService;
    constructor(incidentHandleService: IncidentHandleService);
    list(page?: string, limit?: string, status?: string, severity?: string): Promise<{
        data: ({
            class: {
