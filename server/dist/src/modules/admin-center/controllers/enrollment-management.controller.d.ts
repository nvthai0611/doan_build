...
export declare class EnrollmentManagementController {
    private readonly enrollmentManagementService;
    constructor(enrollmentManagementService: EnrollmentManagementService);
