...
exports.SessionRequestsService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../../db/prisma.service");
let SessionRequestsService = class SessionRequestsService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async getSessionRequests(params) {
        const { teacherId, classId, status = 'all', requestType, search = '', fromDate, toDate, page = 1, limit = 10 } = params;
    ...
    async createSessionRequest(sessionRequestData) {
        ...
        if (sessionRequestData.roomId) {
            ...
            if (!room) {
                throw new common_1.NotFoundException('Phòng học không tồn tại');
            }
        }
        const sessionDate = new Date(sessionRequestData.sessionDate);
        if (sessionDate <= new Date()) {
            throw new common_1.BadRequestException('Ngày buổi học phải trong tương lai');
        }
    ...
    async approveSessionRequest(sessionRequestId, action, approverId, notes) {
        ...
        if (!existingRequest) {
            throw new common_1.NotFoundException('Yêu cầu tạo buổi học không tồn tại');
        }
        if (existingRequest.status !== 'pending') {
            throw new common_1.BadRequestException('Yêu cầu này đã được xử lý');
        }
...
exports.SessionRequestsService = SessionRequestsService;
exports.SessionRequestsService = SessionRequestsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], SessionRequestsService);
//# sourceMappingURL=session-requests.service.js.map