...
class UpdateSubjectDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { code: { required: false, type: () => String, maxLength: 20 }, name: { required: false, type: () => String }, description: { required: false, type: () => String } };
    }
}
exports.UpdateSubjectDto = UpdateSubjectDto;
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'MATH' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Toán học' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
