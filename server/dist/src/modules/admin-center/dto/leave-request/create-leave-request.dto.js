...
class CreateLeaveRequestDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { teacherId: { required: true, type: () => String }, requestType: { required: true, type: () => String }, reason: { required: true, type: () => String }, startDate: { required: true, type: () => String }, endDate: { required: true, type: () => String }, notes: { required: false, type: () => String } };
    }
}
...
], CreateLeaveRequestDto.prototype, "teacherId", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateLeaveRequestDto.prototype, "requestType", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
